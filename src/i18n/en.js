const en = {
  ...
  hero: {
    ...
    subtitleAccent: "digital experiences",
  ...
  resume: {
    tag: "// RESUME",
    heading: "Pick a Secret CV {accent}",
    headingAccent: "mystery",
    subtitle: "4 Secret CVs await — only 1 holds the real Resume. Choose wisely and test your luck!",
    mystery: "SECRET CV",
